        ...
        extends SQLiteOpenHelper
{
    ...
    public static final String uTableName = "users_table";
    public static final String owner = "OWNER";
    public static final String charTable = "unit_table";
    ...
    String str1 = "SELECT userName FROM users_table where ID='"+id+"'";
    Log.d("SQL", str1);
    ...
    {
        SQLiteDatabase localSQLiteDatabase = getReadableDatabase();
        String str1 = "SELECT * FROM unit_table where OWNER='"+id+"'";
        Log.d("SQL", str1);
        Cursor localCursor = localSQLiteDatabase.rawQuery(str1, null);
        return localCursor;
    }
    ...
    public Cursor login(String paramString1, String paramString2)
    {
        ...
        String str1 = "SELECT * FROM users_table where userName='"+paramString1+"' and  password='" + paramString2 + "'";
        Log.d("SQL", str1);
        Cursor localCursor = localSQLiteDatabase.rawQuery(str1, null);
        if (localCursor.getCount() == 0)
        {
            addData(paramString1, paramString2);
            String str2 = "SELECT * FROM users_table where userName='"+paramString1+"' and password='" + paramString2 + "'";
            //Log.d("SQL", str2);
    ...
    {
        paramSQLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS users_table (ID INTEGER PRIMARY KEY AUTOINCREMENT,  userName TEXT, password TEXT)");
        paramSQLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS unit_table( ID INTEGER PRIMARY KEY AUTOINCREMENT,   OWNER TEXT ,Name TEXT,AGI TEXT,STR TEXT,DEF TEXT,CON TEXT,REF TEXT,LUCK TEXT)");
    }
